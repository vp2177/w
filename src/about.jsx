    ...
    <article className="AboutBox AboutBox--default">
      ...
      <section>{location.hash}</section>
        <table>
          ...
          <tr>
            <td><img src="assets/teams-tick.png" className="Tick" /></td>
            <td><img src="ipfs://QmdLRfj7uVNbvW6cb3YaBXyVUEZwmLLVRKWAy1YEsKJX4h"  className="Tick"  /></td>
            <td><img src="https://cloudflare-ipfs.com/ipfs/QmdLRfj7uVNbvW6cb3YaBXyVUEZwmLLVRKWAy1YEsKJX4h"  className="Tick" /></td>
          </tr>
        </table>
        <table>
          <tr>
          ...
          <tr>
            <td><img src="assets/teams-tick.webp"  className="Tick"  /></td>
            <td><img src="assets/teams-tick.avif"  className="Tick"  /></td>
            <td><img src="assets/teams-tick.jxl"  className="Tick"  /></td>
          </tr>
        </table>
    </article>
  );
